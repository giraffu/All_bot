...
env_file = os.getenv("RUNPOD_WORKER_ENV_FILE")
if env_file:
...
logger = logging.getLogger("runpod_relay")

app = FastAPI(title="AllBot RunPod Relay")
...
async def shutdown() -> None:
    ...
    logger.info("runpod_relay_stopped")
