...
LAN_AIO_ALL_ENV = {
    **LAN_AIO_LTX_T2V_ENV,
    ...
    "RUNPOD_TEST_CENTRAL_API_URL": "https://worker-central-test.aivison.it.com",
    "RUNPOD_TEST_AGENT_SECRET_TOKEN": "${LAN_AIO_TEST_AGENT_SECRET_TOKEN:?}",
    ...
    "RUNPOD_TEST_AGENT_ID_PREFIX": "lan_aio_test_ltx25_video_upscale",
    "RUNPOD_TEST_SUPPORTED_TASK_TYPES": "ltx25_video_upscale",
    "RUNPOD_TEST_RUNTIME_PROFILE": "ltx25_video_upscale",
    "RUNPOD_TEST_POOL_PROVIDER": "lan_ssh",
    "RUNPOD_TEST_NODE_ID": "gpu-226",
}
LAN_AIO_MINIMAX_H3_ENV = {
    "COMFYUI_DIR": "/opt/ComfyUI",
    "COMFY_PROCESS_RECOVERY_ENABLED": "true",
    "COMFY_PROCESS_RECOVERY_MIN_FAILURES": "3",
    "COMFY_PROCESS_RECOVERY_SECONDS": "60",
}
