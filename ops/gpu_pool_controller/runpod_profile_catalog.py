...
RUNPOD_MINIMAX_H3_MODEL_PREFIX = (
    "minimax_h3/2026-08-26-10eros-v3-official-int8-h3-turbo-profiles-addon17"
)
RUNPOD_MINIMAX_H3_MODEL_MANIFEST_KEY = (
    "minimax_h3/2026-08-26-10eros-v3-official-int8-h3-turbo-profiles-addon17/manifest.json"
)
