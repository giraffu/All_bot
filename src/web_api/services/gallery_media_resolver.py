...
async def _resolve_first_gallery_r2_public_url(
    ...
    *,
    ...
    for object_key in object_keys:
        if await async_r2_object_exists_fn(object_key):
            return get_r2_public_url_fn(object_key) or ""
    return ""
...
async def build_gallery_media_url(
    ...
    *,
    ...
    r2_url = await _resolve_first_gallery_r2_public_url(
