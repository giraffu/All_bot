...
class ImageService:
    async def submit_ltx_video_task(self, task_id: str, prompt: str, image_path: str, width: int = 1280, height: int = 704, length: int = 241, priority: int = 0) -> str:
        ...
        return await submit_ltx_video(task_id, prompt, image_path, width=width, height=height, length=length, priority=priority)
    ...
    async def submit_face_video(self, task_id: str, face_image_path: str, video_path: str, resolution: int = 512, duration: int = 121, priority: int = 0) -> str:
        ...
        return await submit_face_video(task_id, face_image_path, video_path, resolution=resolution, duration=duration, priority=priority)

    async def submit_task(self, task_id: str, prompt: str, image_paths: list[str], negative_prompt: str, priority: int = 0) -> str:
        """Submit image generation task"""
        return await submit_img2img(task_id, prompt, image_paths, negative_prompt, priority=priority)

    async def submit_face_swap_task(self, task_id: str, face_image_path: str, body_image_path: str, priority: int = 0) -> str:
        """Submit face swap task"""
        return await submit_face_swap(task_id, face_image_path, body_image_path, priority=priority)
    ...
    async def submit_img2img_lora_task(self, task_id: str, prompt: str, image_paths: list[str], lora_name: str, negative_prompt: str = " ", priority: int = 0, lora_strength: float = 1.0) -> str:
        ...
        return await submit_img2img_lora(task_id, prompt, image_paths, lora_name, negative_prompt=negative_prompt, priority=priority, lora_strength=lora_strength)
    ...
    async def submit_perfect_video_edit(self, task_id: str, prompt: str, image_path: str, width: int = 512, height: int = 512, length: int = 81, priority: int = 0) -> str:
        ...
        return await submit_perfect_video_edit(task_id, prompt, image_path, width=width, height=height, length=length, priority=priority)
    ...
    async def submit_perfect_video_lora(self, task_id: str, prompt: str, image_path: str, lora_name: str, width: int = 512, height: int = 512, length: int = 81, priority: int = 0) -> str:
        ...
        return await submit_perfect_video_lora(task_id, prompt, image_path, lora_name, width=width, height=height, length=length, priority=priority)

    async def submit_perfect_video_insert_task(self, task_id: str, prompt: str, image_path: str, width: int = 512, height: int = 512, length: int = 81, priority: int = 0) -> str:
        """Submit perfect video insert task"""
        return await submit_perfect_video_insert(task_id, prompt, image_path, width=width, height=height, length=length, priority=priority)
