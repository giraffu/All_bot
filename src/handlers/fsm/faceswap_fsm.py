...
from src.utils import robust_reply_text, robust_edit_text, load_prompts
...
async def receive_body_image(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    face_path = context.user_data['faceswap_data']['face_image_path']
    body_path = context.user_data['faceswap_data']['body_image_path']
    ...
    context.user_data['faceswap_data'].pop('face_image_path', None)
    context.user_data['faceswap_data'].pop('body_image_path', None)
