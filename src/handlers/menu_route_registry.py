...
SPECIAL_TRANSLATION_ROUTES = (
    ...
    ("qqcc.menu.ai_video", "qqcc.menu.ai_video"),
...
LEGACY_TEXT_ALIASES = {
    ...
    "AI动图V1": "menu.video_edit_v1",
    "AI动图V2": "menu.video_edit",
    "AI绘图": "qqcc.menu.ai_draw",
    "AI绘图V1": "qqcc.menu.ai_draw_v1",
    "AI绘图V2": "qqcc.menu.ai_draw",
    "AI滤镜": "qqcc.menu.ai_filter",
    "AI视频": "qqcc.menu.ai_video",
