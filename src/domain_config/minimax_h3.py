...
MINIMAX_H3_ADDON_MODELS = {
    ...
    "anus": MiniMaxH3AddonModel(
        ...
        "推荐 1.0。滑块控制主 LoRA；辅助运动 LoRA 自动取滑块值的 35%（例如 1.0 → 0.35），无需另设。",
        "Recommended 1.0. The slider controls the main LoRA; the motion-assist LoRA automatically uses 35% of that value (for example, 1.0 → 0.35), with no separate setting.",
