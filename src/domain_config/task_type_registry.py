...
TASK_TYPE_REGISTRY: dict[str, TaskTypeRegistryEntry] = {
    ...
    MODE_LTX_VIDEO_V2: _entry(
        MODE_LTX_VIDEO_V2,
        central_type=MODE_LTX_VIDEO_V2,
        workflow_filename="LTX 2.3 10Eros v1.4 DMD I2V.json",
        is_generation=True,
        is_video=True,
        gallery_supported=False,
        apply_input_reuse_supported=False,
        cost=10,
    ),
    MODE_LTX_VIDEO_V2_FLF2V: _entry(
        MODE_LTX_VIDEO_V2_FLF2V,
        public_type=MODE_LTX_VIDEO_V2,
        execution_type=MODE_LTX_VIDEO_V2_FLF2V,
        central_type=MODE_LTX_VIDEO_V2_FLF2V,
        workflow_filename="LTX 2.3 10Eros v1.4 DMD FLF2V.json",
        is_generation=True,
        is_video=True,
        gallery_supported=False,
        apply_input_reuse_supported=False,
    ...
    MODE_MINIMAX_H3_T2V: _entry(
        MODE_MINIMAX_H3_T2V,
        central_type=MODE_MINIMAX_H3_T2V,
        workflow_filename="MiniMax H3 T2V.api.json",
    ...
    MODE_MINIMAX_H3_I2V: _entry(
        MODE_MINIMAX_H3_I2V,
        central_type=MODE_MINIMAX_H3_I2V,
        workflow_filename="MiniMax H3 I2V.api.json",
        runpod_profile="minimax_h3",
        is_generation=True,
        is_video=True,
        cost=10,
    ...
    MODE_MINIMAX_H3_FLF2V: _entry(
        MODE_MINIMAX_H3_FLF2V,
        central_type=MODE_MINIMAX_H3_FLF2V,
        workflow_filename="MiniMax H3 FLF2V.api.json",
        runpod_profile="minimax_h3",
        is_generation=True,
        is_video=True,
        cost=10,
    ...
    MODE_MINIMAX_H3_REF2V: _entry(
        MODE_MINIMAX_H3_REF2V,
        central_type=MODE_MINIMAX_H3_REF2V,
        workflow_filename="MiniMax H3 REF2V.api.json",
        runpod_profile="minimax_h3",
        is_generation=True,
        is_video=True,
        cost=12,
