...
| `allbot-prompt-optimizer` | 版本化 Profile/模板、多模态优化 Worker、文本结果 |
| `allbot-media-enhance-platform` | 独立媒体增强产品、账本、任务/attempt、Worker 契约 |
...
| `allbot-company-operations` | 公司主体、财税、银行/支付商户、账套记账/月结、备案与本机私密运行日志 |
