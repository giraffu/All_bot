...
- **人物参考图**：在练功房把一张成年人物源图制作成正脸、全身正面、全身侧面、
  全身背面四张素材；每个槽位可独立生成或直接上传，四张完成后合成为官方风格
  单人物面板并保存到修仙笔记的人物图库
...
人物参考图模式使用独立工作台：上传源图并创建免费草稿，在正脸、全身正面、
全身侧面、全身背面四个 tab 间编辑中文默认提示词；默认词要求同一成年人完全
裸体、单人黑底并锁定对应视角。每个槽位可选择自由 P 图流程独立生成并按该流程
计费，也可直接上传 PNG/JPEG/WebP 图片，直传不创建任务、不扣费。四张全部 ready
后才能合成左侧大幅正脸、右侧全身正/侧/背的官方风格单人物面板。人物资产在
