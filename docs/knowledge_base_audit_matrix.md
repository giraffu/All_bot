...
| `docs/子模块_LTX25视频高清化_ltx25_video_upscale.md` | LTX-2.5 IC V2V 2x 视频高清化、模型许可、独立 GPU profile、正式 Pod 内 prod/test 双 consumer 与入口门禁 | task registry、workflow/patcher、model manifest、Web/Bot、RunPod profile/runtime | runtime-verification-required | 视频高清化开发/发布 |
