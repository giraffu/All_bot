...
| `docs/子模块_MiniMaxH3视频服务_minimax_h3.md` | MiniMax H3 三个公开模式、固定 10Eros/LightX2V 基础链、八个可选 LoRA、模型包与 canary | task registry、API workflow、profile、model manifest | runtime-verification-required | MiniMax H3 开发/发布 |
