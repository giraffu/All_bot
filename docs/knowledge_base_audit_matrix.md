...
| `docs/子模块_MiniMaxH3视频服务_minimax_h3.md` | MiniMax H3 三个公开模式、固定作者资产拆分模型包与 canary | task registry、API workflow、profile、model manifest | runtime-verification-required | MiniMax H3 开发/发布 |
