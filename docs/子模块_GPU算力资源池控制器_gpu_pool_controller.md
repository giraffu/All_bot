...
| `gpu-252` | `allbot-gpu-252` / `192.168.1.252` | 1 x RTX 4090 48G active | 正式 LAN AIO GPU0 `img2img_lora` `8192`，承接 `img2img` / `img2img_lora`；`image_to_video`、PornMaster Flux2 edit 与 SCAIL-2 是同卡回切候选；故障 RTX 4090 已拆除，GPU1 `wan22_video_v2` 本地 AIO 当前 maintenance disabled，RunPod 兜底 |
