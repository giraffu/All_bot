...
集成 AI 启动合并、测试和 main 更新时，会冻结当次批次的交接成员。之后新窗口仍可认领其它空闲槽位并继续开发；新任务属于后续批次，当前集成流程不会合入、刷新、停放或清理它的工作区，也不会因为它尚未完成而延迟当前批次。

批次成员按槽位、任务分支、PR 和交接 head 共同识别。已验收成员释放槽位后，该槽位可立即被新任务复用；集成 AI 收尾时会重新核对身份，不会把后来的任务误当作旧成员操作。当前批次完成 main 更新和血缘同步后，才重新盘点下一批可交付任务。
