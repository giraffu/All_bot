...
运维边界：
- gpu-002 GPU0 当前由 `scripts/lan_scail2_aio_prod.sh` 管理 SCAIL-2 正式 AIO；GPU1 当前由 `scripts/lan_runpod_aio_prod_canary.sh` / `scripts/lan_aio_prod_ops.sh` 的 slot1 口径承载 image_to_video AIO。
