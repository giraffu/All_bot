...
2026-06-28 `gpu-002-gpu1-pornmaster_flux2_edit` 曾接管 slot1，之后与 image_to_video 多次同卡回切。2026-07-17 该卡切到 `gpu-002-gpu1-i2i_pro`；2026-07-24 FP8 slot 随 execution profile 一并退役，不再是回切候选。当前 i2i_pro 接 `i2i_pro,t2i-pornmaster-turbo,face_swap_v2`，image_to_video 仍是同卡候选；不得让两个 8191 容器或两个 GPU1 agent 同时 enabled。
