...
export const MINIMAX_H3_ADDON_OPTIONS = [
  ...
  },
  {
    ...
    defaultStrength: 1.0,
    supportedModes: ['t2v', 'i2v'] as readonly MiniMaxH3Mode[],
  },
  { value: 'mystic_xxx', labelKey: 'lab.workbench.minimax_h3_addon_options.mystic_xxx', defaultStrength: 1.0 },
...
export const WEB_CHARACTER_LIBRARY_PICKER_ENABLED = (
...
export const UNIFIED_LAB_MODES = LAB_MODE_CONFIGS.filter(mode => (
  ...
  && (mode.id !== 'character_reference' || WEB_CHARACTER_LIBRARY_PICKER_ENABLED)
