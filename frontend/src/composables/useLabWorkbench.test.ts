...
describe('useLabWorkbench LTX payloads', () => {
  ...
  it('restores an H3 extension route as video-reference continuation', async () => {
    const workbench = createWorkbench('minimax_h3_ref2v', {
    ...
    expect(workbench.minimaxH3Mode.value).toBe('ref2v')
    expect(workbench.uploadedReferences.value).toEqual([])
