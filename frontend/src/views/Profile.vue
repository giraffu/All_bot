...
<template>
  <div class="profile-container space-y-6">
    ...
    <div class="mt-8 bg-slate-900/40 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 shadow-[0_4px_12px_rgba(0,0,0,0.2)]">
      ...
      <p class="text-slate-400 mb-4">通过侧边栏的【自定义功能】和【懒人功能】探索更多 AI 图像与视频生成玩法。</p>
      <div class="flex flex-wrap gap-3">
        ...
        <a-button @click="$router.push('/lazy-features')" class="bg-slate-800 border-slate-600 text-slate-300 hover:text-cyan-300 hover:border-cyan-500/50">
          探索 懒人功能
        </a-button>
      </div>
    </div>
