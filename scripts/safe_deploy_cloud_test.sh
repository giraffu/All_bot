...
echo "RETIRED: use python scripts/test_train_release.py and scripts/release.py; local compose builds are forbidden." >&2
exit 2
...
echo "3️⃣ 构建云测试控制面镜像..."
compose build central-api-test web-api-test
...
compose up -d --no-deps web-api-test
