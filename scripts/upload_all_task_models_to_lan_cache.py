...
OPTIONAL_TARGETS: tuple[TargetSpec, ...] = (
    ...
    TargetSpec(
        name="minimax_h3",
        prefix="minimax_h3/2026-08-19-10eros-beta2-addon13-lightx2v8-mystic-v2",
        manifest_key="minimax_h3/2026-08-19-10eros-beta2-addon13-lightx2v8-mystic-v2/manifest.json",
        bundle_versions=(("minimax_h3_runtime", "2026-08-19-10eros-beta2-addon13-lightx2v8-mystic-v2"),),
    ),
)
TARGETS_BY_NAME = {
