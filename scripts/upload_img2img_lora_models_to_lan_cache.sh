...
usage() {
  cat <<'USAGE'
Usage:
  scripts/upload_img2img_lora_models_to_lan_cache.sh [--dry-run|--execute] [--env-file <path>]

Uploads the img2img_lora_baseline model bundle from /srv/allbot/model-registry
to the LAN model cache bucket allbot-model-cache/img2img_lora/2026-06-10.
USAGE
}
