...
SIMPLE_TASK_ROUTE_SPECS = (
    ...
    ("/api/v1/ltx_video_v2", LtxVideoRequest, "ltx_video_v2", "create_ltx_video_v2_task"),
    (
        "/api/v1/ltx_video_v2_flf2v",
        LtxVideoFlf2VRequest,
        "ltx_video_v2_flf2v",
        "create_ltx_video_v2_flf2v_task",
    ),
    (
    ...
    (
        "/api/v1/ltx25_video_upscale",
        Ltx25VideoUpscaleRequest,
        "ltx25_video_upscale",
        "create_ltx25_video_upscale_task",
    ),
